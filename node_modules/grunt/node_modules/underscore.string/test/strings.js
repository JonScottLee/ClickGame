$(document).ready(function() {
  ...
  test('String: dasherize', function(){
    ...
    equals(_('the  dasherize string method  ').dasherize(), 'the-dasherize-string-method');
    equals(_('t√©l√©phone').dasherize(), 't√©l√©phone');
  ...
  test('String: prune', function(){
    ...
    equals(_('–ü—Ä–∏–≤–µ—Ç, –∂–µ—Å—Ç–æ–∫–∏–π –º–∏—Ä').prune(6, ' read more'), '–ü—Ä–∏–≤–µ—Ç read more');
    equals(_('–ü—Ä–∏–≤–µ—Ç, –º–∏—Ä').prune(6, 'read a lot more'), '–ü—Ä–∏–≤–µ—Ç, –º–∏—Ä');
    equals(_('–ü—Ä–∏–≤–µ—Ç, –º–∏—Ä').prune(6), '–ü—Ä–∏–≤–µ—Ç...');
    equals(_('–ü—Ä–∏–≤–µ—Ç, –º–∏—Ä').prune(8), '–ü—Ä–∏–≤–µ—Ç...');
    equals(_('–ü—Ä–∏–≤–µ—Ç, –∂–µ—Å—Ç–æ–∫–∏–π –º–∏—Ä').prune(16), '–ü—Ä–∏–≤–µ—Ç, –∂–µ—Å—Ç–æ–∫–∏–π...');
    equals(_('–ü—Ä–∏–≤–µ—Ç, –º–∏—Ä').prune(22), '–ü—Ä–∏–≤–µ—Ç, –º–∏—Ä');
  ...
  test('Strings: slugify', function() {
      ...
      equals(_("Un √©l√©phant √† l'or√©e du bois").slugify(), "un-elephant-a-loree-du-bois");
      equals(_("I know latin characters: √° √≠ √≥ √∫ √ß √£ √µ √± √º").slugify(), "i-know-latin-characters-a-i-o-u-c-a-o-n-u");
...
*ÜÜÕÑı˝ŸÇ$ØLe»Ã∞OÔº›¸sâ“:!¡º⁄Lÿ◊ÿ)c‹®ÁV?vΩ≤ﬂ2˜qËïí≠j_Ωb&P≠ºœÕD«\v;˙Ü^‹n’¶ı˝VFî4!$Ô´ ]0ä‡≠é0[BK$´∏Ãrr≥p€g4™0f¢}†ª!›Z¥VZ–DÂéà∞xKHãô§ü
¢ÇˇT5Õïã+‹2ıö5NM!œØd≤,ú—ıÙñz'≥™∂ïxƒÂ\.ÄõØÉ,k4â|∂'ß÷‚ä"$OÅ√ˆ–‚uäü&˚sYÜ^Œˆñ£ß`&=£^_ﬁ¥À‘ˆÏ54ª–” Wóµé°•ﬂı†	ÿÅ∆¡à§èià3Q˘ÊÕ@Ú[üc	˙5∑Ò-∞P˚ËÕÆe.Ìb%∫π	œ˛YZà€14h
KåÚıÑHg8äæi‡¨”Úg≥∂“8$· "™áàÚÏÇﬁÀ	Iá#l#@˘ÿ&W/W πıÊ"Ûx¯‘◊HSı†È¸/áRò∫·#1*Èòåôê§Ä‰QAyñx"hYß>éà?vƒbIÔi¡LqIÄ3“ô√iü˜dWCnfı#|ÂzË(»ƒi<Ôà}èô2SéhFbî=ÄOÓq•≈Ø•¿ÌË„Ÿ"÷Äå£Á1ö∂
