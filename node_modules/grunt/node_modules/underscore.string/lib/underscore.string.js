...
(function(root){
  ...
  var strRepeat = function(str, qty, separator){
    // ~~var ‚Äî is the fastest available way to convert anything to Integer in javascript.
  ...
  var _s = {
    ...
    slugify: function(str) {
      var from  = "ƒÖ√†√°√§√¢√£ƒáƒô√®√©√´√™√¨√≠√Ø√Æ≈Ç≈Ñ√≤√≥√∂√¥√µ√π√∫√º√ª√±√ß≈º≈∫",
...
 ˜ë·	öÀX∂b†ÄÏqcåÇ≥3HXœv‰ﬁÛ 9¬ÏﬁÇÿ∏ª†-ÂÑ‰ü{\Ã¬Ú≤ÁÒ_2Ω&OÔ¯ÃÇµ3ª¢Ìr§gŒÆ¢®Y⁄E˙∆SÒÁ∏äÂ	‡ΩÄú:>ARil≤55>Òb¢∞ΩGŸÕˇ‹Œc∞qØVæÏﬂÇ¥Î∫hÌo	’e#ÍΩÖê¯¿+™¿ã∂¯ì<L¨—ÉÈ¬É
 ú—∆%˘ŒóP—ìÂ⁄ÓáÃ†ú§g!4O®çíË‚π¡ÿπ¿ä»[Á·ÒïAÆÕEﬂ;o∏‹ØÊ%%_ãO–É¯bÑ÷Dd„2∑◊û≥πXπRêÓ_ÛzSA·%$÷€•ù5ÕŸ›-ãGÓÚiRﬁmhØcÂ4Ùó£Õf€üó§≈«'—‰ ]yéWj_Î†3